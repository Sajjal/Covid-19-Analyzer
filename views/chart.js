...
!(function(t) {
    ...
    return (function t(e, n, i) {
        ...
        for (
            var o = "function" == typeof require && require, r = 0; r < i.length; r++
        )
            a(i[r]);
        return a;
    })({
            ...
            function(t, e, n) {
                function i(t) {
                    ...
                    return (
                        ...
                        e < 0 && (e += 360),
                        (i = (l + s) / 2),
                        (n = s == l ? 0 : i <= 0.5 ? u / (s + l) : u / (2 - s - l)), [e, 100 * n, 100 * i]
                    );
                }
                ...
                function z(t) {
                    ...
                    return (
                        ...
                        (i =
                            ...
                            108.883 * Math.pow(a - l / 200, 3)), [e, n, i]
                    );
                }
                    ...
                    (t.controllers.bar = t.DatasetController.extend({
                        ...
                        calculateBarValuePixels: function(t, e) {
                            ...
                            return (
                                ...
                                (l = (r - o) / 2), { size: l, base: o, head: r, center: r + l / 2 }
                            );
                        },
                        calculateBarIndexPixels: function(t, e, n) {
                            ...
                            return (
                                ...
                                (l += n.barSpacing / 2), { size: s, base: l, head: l + s, center: l + s / 2 }
                            );
                        },
                        draw: function() {
                            var t,
                    ...
                    e.extend(n.pie, { cutoutPercentage: 0 }),
                        (t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
                            ...
                            getMaxBorderWidth: function(t) {
                                for (
                                    var e, n, i = 0, a = this.index, o = t.length, r = 0; r < o; r++
                                )
                    ...
                    (t.controllers.line = t.DatasetController.extend({
                        ...
                        draw: function() {
                            ...
                            for (
                                ...
                                t.canvasHelpers.unclipArea(i.ctx); s < l;
                                ++s
                            )
                                o[s].draw(r);
                        },
                    ...
                    (t.animationService = {
                        ...
                        addAnimation: function(t, e, n, i) {
                            var a,
                                ...
                                r = this.animations;
                            for (
                                e.chart = t, i || (t.animating = !0), a = 0, o = r.length; a < o;
                                ++a
                            )
                ...
                e.exports = function(t) {
                    ...
                    a.extend(t.prototype, {
                            ...
                            transition: function(t) {
                                for (
                                    var e = this, n = 0, i = (e.data.datasets || []).length; n < i;
                                    ++n
                                )
                            ...
                            drawDatasets: function(t) {
                                ...
                                if (o.notify(e, "beforeDatasetsDraw", [t]) !== !1) {
                                    for (
                                        var n = (e.data.datasets || []).length - 1; n >= 0;
                                        --n
                                    )
                            ...
                            getVisibleDatasetCount: function() {
                                for (
                                    var t = 0, e = 0, n = this.data.datasets.length; e < n;
                                    ++e
                                )
                    ...
                    function n(t, e) {
                        ...
                        for (i = 0, o = l.length; i < o; ++i)
                            if (t.isDatasetVisible(i))
                                for (
                                    n = t.getDatasetMeta(i), a = 0, r = n.data.length; a < r;
                                    ++a
                                ) {
                                    var s = n.data[a];
                                    s._view.skip || e(s);
                    ...
                    (t.Scale = t.Element.extend({
                        ...
                        update: function(t, e, n) {
                            ...
                            return (
                                ...
                                (a.maxWidth = t),
                                (a.maxHeight = e),
                                (a.margins = i.extend({ left: 0, right: 0, top: 0, bottom: 0 },
                                    n
                                )),
                            ...
                            if (t.options.display && t.isHorizontal())
                                for (
                                    var l,
                                        ...
                                        d = u,
                                        c = t.getPixelForTick(1) - t.getPixelForTick(0) - 6; d > c && r < a.maxRotation;
                ...
                e.exports = function(t) {
                    ...
                    function o(t, e) {
                        ...
                        return (
                            ...
                            s.each(e.footer, g),
                            (a += 2 * e.xPadding), { width: a, height: i }
                        );
                    }
        ...
        49: [
            function(t, e, n) {
                ...
                (e.exports = function(t) {
                    ...
                    function n(t, e, n, i) {
                        for (
                            var a, o = Object.keys(l), r = o.length, s = o.indexOf(t); s < r; s++
                        ) {
                            a = o[s];
                            var u = l[a],
